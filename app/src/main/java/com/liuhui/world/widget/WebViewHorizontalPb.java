package com.liuhui.world.widget;
...
public class WebViewHorizontalPb extends View {
    ...
    public WebViewHorizontalPb(Context context) {
        this(context, null);
    }

    public WebViewHorizontalPb(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WebViewHorizontalPb(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            mWidth = DensityUtil.dp2px(mContext, 300);
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            mHeight = DensityUtil.dp2px(mContext, mDefaultHeight);
        }
